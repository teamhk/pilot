	   ...
	   String grade;
		...
		public String toString() {
			return "FinalPay [id=" + id + ", pwd=" + pwd + ", name=" + name + ", email=" + email + ", pnum=" + pnum
					...
					+ ", cardExp=" + cardExp + ", cardCvc=" + cardCvc + ", sname=" + sname + ", saddress=" + saddress
					+ ", snum=" + snum + ", scontact=" + scontact + ", bank=" + bank + ", bnum=" + bnum + ", permit="
					+ permit + ", s_date=" + s_date + ", area_num=" + area_num + ", sdcheck=" + sdcheck + ", items="
					+ items + ", check=" + check + ", cart_seq=" + cart_seq + ", blouse_p=" + blouse_p + ", shirt_p="
					+ shirt_p + ", t_shirt_p=" + t_shirt_p + ", b_price=" + b_price + ", bubble=" + bubble + ", b_date="
					+ b_date + ", p_bubble=" + p_bubble + "]";
		}
